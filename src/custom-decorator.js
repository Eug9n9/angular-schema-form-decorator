...
function(decoratorsProvider, sfBuilderProvider, sfPathProvider) {
  ...
  decoratorsProvider.defineDecorator('customDecorator', {
    ...
    'eso-button': {template: base + 'eso-button.html', builder: defaults},
    'eso-section': {template: base + 'eso-section.html', builder: [sfField, transclusion, condition]},
    'eso-submit': {template: base + 'eso-button.html', builder: defaults},
    'eso-title': {template: base + 'eso-title.html', builder: defaults},
